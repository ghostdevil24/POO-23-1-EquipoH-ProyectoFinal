...
public class Alumno {
    ...
    public Alumno(String nombre, String apPaterno, String apMaterno, Integer numcuenta, Integer edad, Double promedio, Double escolaridad, Integer semestre, String direccion, Integer numinscripcion, Integer materiasReprobadas, Double velocidad) {
        this.nombre = nombre;
